...
const seedifyLockedPoolAddresses: string[] = [process.env.LOCKED_STAKING_7D, process.env.LOCKED_STAKING_14D, process.env.LOCKED_STAKING_30D, process.env.LOCKED_STAKING_60D, process.env.LOCKED_STAKING_90D, process.env.LOCKED_STAKING_180D].filter(addr => addr !== undefined) as string[]
