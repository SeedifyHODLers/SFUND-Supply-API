...
export class SeedifyLockedFarmingDataFetcherETH extends SeedifyLockedFarmingContractETH implements DataFetcher {
  ...
  public get infos(): LockedFarmingInfos {
    ...
    return new LockedFarmingInfos(this.stakedAmount, this.pendingAmount, rewardPerSec, this._stakingToken.symbol,
      this._userDeposit.amount / this._stakingToken.decimals, this.allStakedAmount / this._rewardToken.decimals, intialStakeDate, this._lockDuration, this.chainId || 1)
  }
